...
public class JDialogVerMovimientos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTableMovimientos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero De Movimiento", "Importe", "Tipo", "Fecha", "Descripcion"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogVerMovimientos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVerMovimientos dialog = new JDialogVerMovimientos(new javax.swing.JFrame(), true);
